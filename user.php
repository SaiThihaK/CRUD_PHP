...
if (isset($_POST['submit'])) {
    ...
    $query = "insert into `user`(username,email,phone,password) values('$username','$email','$password','$phone')";
...
<body>
    <div class="container">
        <h1 class="d-flex justify-content-center mb-10">User Management System</h1>
        <div>
